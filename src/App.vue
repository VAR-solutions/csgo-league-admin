  ...
  <v-app>
    ...
    <v-navigation-drawer dark v-model="drawer" absolute temporary>
      <v-list nav dense>
          ...
          <v-list-item active-class="grey--text text--accent-4" :to="{ name: 'Fixtures'}" exact>Fixtures</v-list-item>
          <v-list-item active-class="grey--text text--accent-4" :to="{ name: 'PointsTable'}" exact>Points Table</v-list-item>
