  ...
  <v-app>
    ...
    <v-navigation-drawer dark v-model="drawer" absolute temporary>
      <v-list nav dense>
          ...
          <v-list-item active-class="grey--text text--accent-4" exact>Teams</v-list-item>
          <v-list-item active-class="grey--text text--accent-4" exact>Auction</v-list-item>
          <v-list-item active-class="grey--text text--accent-4" :to="{ name: 'Announcements' }" exact>Announcements</v-list-item>
          <v-list-item active-class="grey--text text--accent-4" exact>Fixtures</v-list-item>
          <v-list-item active-class="grey--text text--accent-4" exact>Points Table</v-list-item>
          <v-list-item active-class="grey--text text--accent-4" exact v-if="currentUser" @click="logout">LOGOUT</v-list-item>
      </v-list>
    </v-navigation-drawer>
    <v-content>
      <router-view />
