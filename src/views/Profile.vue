<template>
  <v-container  mt-5>
    <vue-element-loading is-full-screen :active="showCustomizeLoader" background-color="rgba(100, 100, 100, 0.4)">
         <img src="https://firebasestorage.googleapis.com/v0/b/csgo-auction.appspot.com/o/side-03.png?alt=media&token=91ce7293-e061-4a46-8929-d72bb6917499" class="my-3 rotate-vert-center" height="250px">
  </vue-element-loading>
    <v-card pa-2 
      width="90%"
      class="mx-auto"
...
export default {
  ...
  created() {
    setTimeout(() => { this.showCustomizeLoader = false }, 2000)
      fb.playersCollection.doc(this.$route.params.id)
      .get()
      .then(res => {
        this.data = res.data();
      });
